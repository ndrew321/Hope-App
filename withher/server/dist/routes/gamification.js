...
router.get('/users/:id/badges', (0, validationMiddleware_1.validateParams)(UserIdParam), GamificationController.getUserBadges);
router.get('/leaderboards', GamificationController.getLeaderboards);
router.get('/users/:id/streaks', (0, validationMiddleware_1.validateParams)(UserIdParam), GamificationController.getUserStreaks);
